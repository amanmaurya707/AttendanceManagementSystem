...
if(id!=null&&name!=null&&email!=null&&dob!=null&&address!=null&&phoneno!=null&&dept!=null&&sclass!=null&&gender!=null)
{
   try
   {
    ...
    String query="update Studenttbl set Student_Name=?,Class=?,Dept=?,Dob=?,Address=?,Gmail=?,PhoneNumber=?,Gender=? where Student_Id='"+id+"'";//start here from 1,2,3,4 positions
  ...
  //  pstmt.setString(1,a);
    ...
    pstmt.setString(8,gender);
     //out.println("here 5");
    pstmt.executeUpdate();
    response.sendRedirect("view_student_profile.jsp");
   }
   catch(Exception ex)
   {
