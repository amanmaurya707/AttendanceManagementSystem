...
<h1>add faculty</h1>
<form action="add_faculty.jsp" method="get" onsubmit="return myFunction()" name="forms">
	...
	<input type="text" name="txtsubject" placeholder="subjects(for eg:maths/spm)" id="subject" onkeyup="myFunction()">
