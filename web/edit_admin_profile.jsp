...
<title></title>
	...
	<link rel="stylesheet" type="text/css" href="jquery-ui.min.css">
        <script type="text/javascript" language="javascript" src="formverification.js"></script>
</head>
<!--<body>-->
...
<h2>edit admin profile</h2>
    ...
    <%
        ...
        %>
        <form action="edit_admin_profile_status.jsp" method="get" onsubmit="return myFunction()" name="forms">
     ...
     <input type="text" name="txtid" placeholder="id" id="id" onkeyup="myFunction()" value='<%=rs.getString("Admin_Id")%>'>
    
        <span id="msgname" style="color:red"></span>
	<input type="text" name="txtname" placeholder="full name" id="name" onkeyup="myFuntion()" value='<%=rs.getString("Admin_Name")%>'> 
