...
<h2>edit staff profile</h2>
    ...
    <%
        ...
        %>
        <form action="edit_staff_profile_status.jsp" method="get" onsubmit="return myFunction()" name="forms">
     ...
     <input type="text" name="txtid" placeholder="id" id="id" onkeyup="myFunction()" value='<%=rs.getString("Staff_Id")%>'>
